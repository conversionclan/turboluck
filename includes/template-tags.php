...
if ( ! function_exists( 'bento_google_fonts' ) ) {
	...
	function bento_google_fonts() {
		...
		$font_families = array();
		$font_families[] = $open_sans.':400,400i,700';
		$font_families[] = $merriweather.':400i,700';
		$query_args = array(
			'family' => urlencode( implode( '|', $font_families ) ),
		);
		$query_args['subset'] = urlencode( 'cyrillic,latin-ext' );
...
// Include Google Fonts
if ( ! function_exists( 'bento_google_analytics' ) ) {
	
	function bento_google_analytics() {
